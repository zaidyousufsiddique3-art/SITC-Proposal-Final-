        ...
        <div className="min-h-screen flex items-center justify-center bg-ai-bg p-4">
            <div className="w-full max-w-md glass p-8 rounded-2xl border border-slate-700 shadow-2xl">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/sitc-45e52.firebasestorage.app/o/uploaded_image_1764211838209.png?alt=media" className="h-24 mb-4 object-contain" alt="SITC Logo" />
